...
export default withAuth(
  function middleware(req) {
    ...
    const ALLOWED_EMAILS = ["leonardo.decastro.brazil@gmail.com", "janet.ketcham@gladney.org", "lisa.felton@gladney.org", "janet.ketcham@gladney.org","mgarcia@upstart13.com", "itsai@upstart13.com", "mamantea@upstart13.com", "jennifer.james@gladney.org",
